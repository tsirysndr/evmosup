...
pub fn verify_evmosd_home() -> Result<(), Error> {
...
pub fn import_keys() -> Result<(), Error> {
    let val_key = VAL_KEY;
...
pub fn set_gas_limit() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    Command::new("sh")
        .arg("-c")
...
pub fn set_base_fee() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    Command::new("sh")
        .arg("-c")
...
pub fn enable_api() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
...
pub fn disable_rosetta_api() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    let app_toml_path = evmos_home.join("config").join("app.toml");
...
pub fn disable_memiavl() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    let app_toml_path = evmos_home.join("config").join("app.toml");
...
pub fn disable_versiondb() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    let app_toml_path = evmos_home.join("config").join("app.toml");
...
pub fn change_proposal_periods() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
...
pub fn change_pruning_settings() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    let app_toml_path = evmos_home.join("config").join("app.toml");
...
pub fn allocate_genesis_accounts() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
...
pub fn sign_genesis_transaction() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    Command::new("evmosd")
        .stdin(std::process::Stdio::inherit())
...
pub fn collect_gentxs() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    Command::new("evmosd")
        .stdin(std::process::Stdio::inherit())
...
pub fn validate_genesis() -> Result<(), Error> {
    let home = dirs::home_dir().unwrap();
    let evmos_home = home.join(".evmosd");
    Command::new("evmosd")
        .stdin(std::process::Stdio::inherit())
